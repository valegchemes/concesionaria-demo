  ...
  async update(
    ...
    const updated = await prisma.unit.update({
      ...
      data: {
        ...
        ...(command.location !== undefined && { location: command.location?.trim() }),
        ...(command.year !== undefined && { year: command.year }),
        ...(command.vin !== undefined && { vin: command.vin?.trim() }),
        ...(command.domain !== undefined && { domain: command.domain?.trim() }),
        ...(command.engineNumber !== undefined && { engineNumber: command.engineNumber?.trim() }),
        ...(command.frameNumber !== undefined && { frameNumber: command.frameNumber?.trim() }),
